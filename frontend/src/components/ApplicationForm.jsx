      ...
      {(formik) => {
        ...
        return (
          <>
            ...
            <Form>
              <HStack>
                <FormikControl
                  ...
                  type="select"
                  isDisabled={disableAddButton || auth.courses.length > 0}
                />
            ...
            <Text
              fontWeight="bold"
              className="bg-blue-400  text-white text-md pb-1 mb-2 mt-2 text-center"
              align="center"
            >
                      ...
                      <Tr key={index}>
                        ...
                        <Td>
                          <Button
                            ...
                            isDisabled={auth.courses.length > 0}
                          >
                            Delete
                          </Button>
                        </Td>
            ...
            <Button
              ...
              type="button"
              isDisabled={
                auth.courses.length > 0 || appliedPrograms.length == 0
              }
              className="m-3"
            >
