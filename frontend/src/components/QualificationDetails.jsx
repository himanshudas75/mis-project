        ...
        return (
          <VStack align="center">
            <Form>
              <Text
                fontWeight="bold"
                className="bg-white text-md pb-1 mb-2 text-center"
                align="center"
              >
              ...
              <HStack className="mt-3 mb-3" align="center">
                <FormikControl
                  control="select"
                  label="Priority 1"
                  name="priority1"
              ...
              <Text color="red">
                "Institute/University Name field must be less than 100
              ...
              <Box>
                <Text
                  fontWeight="bold"
                  className="bg-white mt-3 text-md pb-1 mb-2 text-center"
                  align="center"
                >
                  Details of Class 10th
                </Text>
                <VStack align="center">
                  <FormikControl
                    control="nestedinput"
              ...
              <Box>
                <Text
                  fontWeight="bold"
                  className="bg-white text-md mt-3 pb-1 mb-2 text-center"
                  align="center"
                >
                  Details of Under Graduate education
                </Text>
