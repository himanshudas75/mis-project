            ...
            {(formik) => {
                return (
                    <Form>
                        ...
                        />
                        <Text color="red">
                            NOTE: Only Numeric Values are allowed in the
                        ...
                        <Text color="red">
                            NOTE:"All appearing students have to give tentative
                            year of passing and marks obtained till last
                            semester."
                        </Text>
                        <Text color="red">
                            "Institute/University Name field must be less than
                            100 characters including space."
                        </Text>
                        ...
                        <Box>
                            ...
                            <FormikControl
                                control="nestedinput"
                                label={
                                    formik.values.tenth_class.grade_type ===
                                    'percentage'
                                        ? 'Enter Percentage'
                        ...
                        <Box>
                            ...
                            <FormikControl
                                control="nestedinput"
                                label={
                                    formik.values.twelfth_class.grade_type ===
                                    'percentage'
                                        ? 'Enter Percentage'
                                        : 'Enter CGPA(out of 10)'
                                }
